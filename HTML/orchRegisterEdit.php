    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold " style="color: #a10202;">Edit Orhestra Information</h6>
            </div>
            <div class="card-body" >
                ...
                if(isset($_POST['edit_btn'])){
                    $orchname=$_POST['edit_id'];
                    $query="SELECT Orchname,showDay,showDate,hallNum,rate,description,photo FROM orch WHERE Orchname='$orchname'";
                    ...
                    foreach($query_run as $row){
                        ...
                        <form action="orchCode.php" method="post" enctype="multipart/form-data">
                            ...
                            <label style="color: #a10202;  font-size: 24px;" ><p>Orchestra Name: <?php echo $row['Orchname']; ?></p></label>

                            <div class="form-group">
                                <input type="hidden" name="edit_name" value="<?php echo $row['Orchname']; ?>" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Show Day</label>
                                <input type="text" name="edit_showday" value="<?php echo $row['showDay']; ?>" autocomplete="off" class="form-control" placeholder="Update Orchestra Show Day">
                            </div>
                            <div class="form-group">
                                <label>Show Date</label>
                                <input type="date" name="edit_showdate"  value="<?php echo $row['showDate']; ?>" autocomplete="off" class="form-control" placeholder="Update Orchestra Show Day">
                            </div>
                            <div class="form-group">
                                <label>Hall Number</label>
                                <input type="number" name="edit_hallnumber"  value="<?php echo $row['hallNum']; ?>"  autocomplete="off" class="form-control" placeholder="Update Orchestra Hall Number">
                            </div>
                            <div class="form-group">
                                <label>Rate</label>
                                <input type="text" name="edit_rate" value="<?php echo $row['rate']; ?>" class="form-control" autocomplete="off" placeholder="Update Orchestra Rate">
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <input type="text" name="edit_description"  value="<?php echo $row['description']; ?>"  autocomplete="off" class="form-control" placeholder="Update Orchestra description">
                            </div>
                            <div class="form-group">
                                <label>Picture</label>
                                <?php
                                ...
                                <input type="hidden" name="hidden_photo" value="<?php echo $row['photo']; ?>">
                                    <label> old photo :<?php echo $row['photo']  ?> </label>

                                <?php
                                }else{?>
                                    <input type="hidden" name="hidden_photo" value="emptyPhoto">
                                ...
                                <!--                                <input type="file" name="edit_photo"  value="../imgs/aboo.jpeg"  autocomplete="off" class="form-control" placeholder="Update Orchestra Picture">-->
                            </div>
...
<!--                                <form action="orchRegisterEdit.php" method="post">-->
