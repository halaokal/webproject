...
<div  style="margin-left:13%;padding:1px 16px;margin-top: 30px">
    <div class="searchh" style="width: 500px ">
        <form action="RegisterOrch.php" method="post" class=" search" style="margin:auto;max-width:300px;border-color: grey ">
    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3" >
                <form method="post" action="RegisterOrch.php">
                    <h6 class="m-0 font-weight-bold " style="color: #a10202;">Orchestra
            ...
            font-size: 24px;">
                    ...
                    $query="SELECT Orchname FROM orch ORDER BY showDate";
 ...
 Number: '.$row.'</h4>';
            ...
            <div class="card-body" >
                ...
                <div class="table-responsive" style="font-size: 20px">
                    <?php
                    $connection=mysqli_connect("localhost","root","","melody");
                    $query="SELECT  Orchname,showDay , hallNum, showDate , description ,photo ,rate  FROM orch";
                    ...
                    if(isset($_POST['searchmovie']))
                    {
                        ...
                        $query = "SELECT * FROM orch WHERE Orchname LIKE '%".$valueToSearch."%'";
                        $query_run = mysqli_query($connection, $query);
                    ...
                    <table class="table table-bordered"  id="dataTable" style="font-size: 20px" width="100%" cellspacing="0">
                        <thead>
                        <tr>
                            <th style="font-size: 17px">Orch. Name</th>
                            ...
                            <th style="font-size: 17px"> Picture</th>
                        ...
                        if(mysqli_num_rows($query_run)>0){
                            while ($row=mysqli_fetch_assoc($query_run)){
                                ...
                                <tr>
                                    <td style="font-size: 20px"><?php echo $row['Orchname']; ?></td>
                                    ...
                                    <td style="font-size: 20px">
                                        <form action="orchRegisterEdit.php" method="post">
                                            <input type="hidden" name="edit_id" value="<?php echo $row['Orchname']; ?>">
                                            <button type="submit" name="edit_btn" class="btn btn-success" style="font-size: 16px">EDIT</button>
                                        </form>
                                    </td>
                                    <td style="font-size: 20px">
                                        <form action="orchCode.php" method="post">
                                            <input type="hidden" name="delete_id" value="<?php echo $row['Orchname']; ?>">
