...
<head>
    ...
    <link rel="stylesheet" href="../CSS/cello.css">
...
<h1 class="lg-title">
    <span class="momo" >C</span>
    <span class="momo" >E</span>
    <span class="momo" >L</span>
    <span class="momo" >L</span>
    <span class="momo" >0</span>
...
<div class = "products" style="background: white; ">
    <div class = "containerr">
        <div class = "product-items">
            <?php
            $sql="SELECT * FROM product WHERE Type='cello'";
            $result = $db->query($sql);
            while($row= $result->fetch_assoc()) {?>
                <form action="addProduct.php? code=<?=$row['Code']?>" method="post">
                    <?php
                    $Name=$row['Name'];
                    $Price=$row['Price'];
                    $Image=$row['Image'];
