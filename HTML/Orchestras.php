...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    if(isset($_POST['btn-cart'])){
        if(isset($_SESSION['cart'])){
            $myItems=array_column($_SESSION['cart'],'Orchname');
            if(in_array($_POST['Orchname'],$myItems)){
...
<head>
    ...
    <link rel="stylesheet" href="../CSS/orchestras.css">
...
<div class = "products" style="background: white; ">
    <div class = "containerr">
        <div class = "product-items">
            <?php
            $sql="SELECT * FROM orch ";
            $result = $db->query($sql);
            while($row= $result->fetch_assoc()) {?>
                <form action="Orchestras.php? code=<?=$row['Code']?>" method="post">
                    <?php
...
<!--                                <a href="suborchestra.php" type = "submit" class = "btn-cart" name="btn-cart"> book a ticket-->
...
<!--                            </div>-->
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "suborchestra.php?code=<?php echo $Code ?>" class = "product-name" ><?php echo $Orchname ?> </a>
                            <input type="hidden" name="Name" value="<?=$Orchname?>">
