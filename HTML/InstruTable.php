...
<div  style="margin-left:13%;padding:1px 16px;margin-top: 30px">
    <div class="searchh" style="width: 500px ">
        <form action="RegisterInst.php" method="post" class=" search" style="margin:auto;max-width:300px;border-color: grey ">
    ...
    <div class="container-fluid" style="margin-top: 40px">
        <div class="card shadow mb-4">
            <div class="card-header py-3" >
                <form method="post" action="RegisterInst.php">
                    <h6 class="m-0 font-weight-bold " style="color: #a10202;">Instrument
...
<!--                                    <td style="font-size: 20px">--><?php //echo $row['availability']; ?><!--</td>-->
=                                    <td style="font-size: 20px"><?php echo $row['Description']; ?></td>
                                    ...
                                    <td style="font-size: 20px">
                                        <form action="RegisterInst_edit.php" method="post">
                                            <input type="hidden" name="edit_id" value="<?php echo $row['Code']; ?>">
                                            <button type="submit" name="edit_btn" class="btn btn-success" style="font-size: 16px">EDIT</button>
                                        </form>
                                    </td>
                                    <td style="font-size: 20px">
                                        <form action="addInstPHP.php" method="post">
                                            <input type="hidden" name="delete_id" value="<?php echo $row['Code']; ?>">
